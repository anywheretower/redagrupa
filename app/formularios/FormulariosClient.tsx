  ...
  return (
    <main id="contenido-principal" className="min-h-screen bg-white">
      ...
      <div className="fixed right-6 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-2">
        ...
        <a href="https://wa.me/56982414614?text=Hola%2C%20quiero%20cotizar%20un%20seguro%20complementario%20de%20salud%20para%20mi%20empresa" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full bg-[#25D366] hover:bg-[#1DA851] flex items-center justify-center shadow-lg transition-colors" aria-label="WhatsApp de RedAgrupa">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-base text-gray-700 leading-[1.1]">
                ...
                escríbenos por <a href="https://wa.me/56982414614?text=Hola%2C%20quiero%20cotizar%20un%20seguro%20complementario%20de%20salud%20para%20mi%20empresa" className="text-[#cc0033] underline hover:no-underline">WhatsApp</a> o al <a href="mailto:cwinter@redagrupa.cl" className="text-[#cc0033] underline hover:no-underline">correo</a>.
              </p>
            </div>
