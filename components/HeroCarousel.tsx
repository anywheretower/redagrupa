...
const slides = [
  {
    ...
    headline: "Seguros Complementarios para tu Pyme desde UF\u00a00,52/mes",
    subtitle: "Comparamos las principales aseguradoras y gestionamos todo por ti: cotización, contratación y reembolsos. Sin trámites eternos ni lenguaje técnico. Tu equipo protegido en días, no meses.",
  ...
  },
  {
    ...
    headline: "+300 Empresas y 9.000 Familias ya confían en RedAgrupa",
    subtitle: "+10 años como corredor de seguros en Chile. Trabajamos con Bupa, BICE Vida, MetLife, Sura y las principales aseguradoras del país.",
    ctaPrimary: { text: "Cotiza Gratis en 2 Minutos", href: "#formulario-contacto" },
  ...
  },
  {
    ...
    headline: "Salud, Vida y Beneficios en una sola gestión",
    subtitle: "Seguro complementario de salud, beneficios corporativos, planes BICE Pyme y seguros individuales. Encuentra la solución que calza con tu empresa.",
    ctaPrimary: { text: "Hablar con un Asesor", href: "#formulario-contacto" },
